...
// Brand Placement table - actual DB columns are snake_case
export const brandPlacement = pgTable('s_brand_placement', {
  ...
  placementClassification: text("placement_classification"),
  bidAdjustmentPct: bigint("bid_adjustment_pct", { mode: "number" }),
  impressions: bigint("impressions", { mode: "number" }),
  viewableImpressions: bigint("viewable_impressions", { mode: "number" }),
  viewabilityRate: numeric("viewability_rate"),
  clicks: bigint("clicks", { mode: "number" }),
  cost: numeric("cost"),
  purchases: bigint("purchases_14d", { mode: "number" }),
  sales: numeric("sales_14d"),
  unitsSold: bigint("units_sold_14d", { mode: "number" }),
  newToBrandPurchases: bigint("new_to_brand_purchases_14d", { mode: "number" }),
  newToBrandSales: numeric("new_to_brand_sales_14d"),
  newToBrandUnitsSold: bigint("new_to_brand_units_sold_14d", { mode: "number" }),
  brandedSearches: bigint("branded_searches_14d", { mode: "number" }),
