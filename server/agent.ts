  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        table: {
          type: "string",
          enum: ["s_products_search_terms", "s_products_placement", "s_brand_search_terms", "s_brand_placement", "s_display_matched_target", "s_display_targeting", "bid_change_history"],
